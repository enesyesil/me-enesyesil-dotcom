...
>
	...
	>
		Software Developer crafting <strong class="font-semibold text-gray-900 dark:text-white"
			>AI/ML systems</strong
		>
		and <strong class="font-semibold text-gray-900 dark:text-white">data infrastructure</strong> that
		power real-world solutions.
	</p>
