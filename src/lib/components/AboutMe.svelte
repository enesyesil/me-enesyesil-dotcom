<script>
	import { CodeBranchSolid, DatabaseSolid, BrainSolid } from 'flowbite-svelte-icons';
</script>
...
<section class="section-padding items-center overflow-hidden" id="about">
	<div class="max-w-6xl mx-auto px-6">
		...
		<div class="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center">
			<!-- Left Column: Interactive Profile Card (Aligns Right towards Center) -->
			<div class="relative flex justify-center lg:justify-end group order-1">
				...
				>
					...
					<div class="flex flex-wrap justify-center gap-2">
						<span class="px-4 py-2 bg-amber-100/80 text-gray-700 rounded-full text-sm font-medium"
			...
			<!-- Right Column: Content (Aligns Left but nudged Right) -->
			<div class="space-y-8 order-2 text-center lg:text-left lg:pl-10">
				...
				<div class="grid grid-cols-3 gap-3 pt-2">
					<div
						class="group/card bg-white/60 backdrop-blur-sm p-4 rounded-2xl text-center shadow-soft hover:shadow-soft-lg hover:-translate-y-1 transition-all duration-300 cursor-pointer border border-amber-50"
					>
						<div
							class="mx-auto w-10 h-10 bg-primary-100 rounded-xl flex items-center justify-center text-primary-600 mb-2 group-hover/card:scale-110 transition-transform"
						>
